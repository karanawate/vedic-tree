                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered  " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <img class="img-rounded" width="100" height="100" src="<?php echo  base_url('uploads/blogs_images/'.$value['file_upload']);?>" />
                                                ...
                                                <td>
                                                 <form method="POST" action="<?php echo base_url('adminseo/edit_blogs'); ?>">
                                                   ...
                                                   <button><i style="font-size: 21px;position:    margin-left: 19px;color:#626ed4;" class="mdi mdi-account-edit-outline"></i></button>
                                                </form>
